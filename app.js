...
const { listDevices, getDeviceDetails } = require('./chirpstack'); // Import fonction gRPC
...
app.get('/api/getdevice/:devEui', async (req, res) => {
    ...
    try {
        const deviceDetails = await getDeviceDetails(devEui); // Utilisation de la fonction getDeviceDetails
        if (!deviceDetails) {
